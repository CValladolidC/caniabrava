...
{
    public partial class ui_accesomenuapp : Form
    {
        public string _idusr;
        public string _desusr;

        public ui_accesomenuapp()
        {
            InitializeComponent();
        }
        ...
        {
            this.Text = "Opciones de Menú APP del Usuario : " + _desusr;
            ui_listar();
        }
        ...
        private void ui_listar()
        {
            ...
            string query = "select  codmenu,desmenu from menu where estado = 2 order by orden asc,codmenu asc";
            ...
            foreach (DataRow row_dtMenu in dtMenu.Rows)
            {
                ...
                indoptmenu = optmenu.getOptMenuApp(_idusr, codmenu);
                if (indoptmenu > 0)
                {
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            optmenu.eliminarOptMenuApp(_idusr);
            ...
            MessageBox.Show("Opciones de Menú APP actualizadas correctamente", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.Close();
        }
    }
}