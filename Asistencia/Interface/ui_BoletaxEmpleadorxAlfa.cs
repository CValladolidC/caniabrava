...
{
    public partial class ui_BoletaxEmpleadorxAlfa : Form
    {
        public ui_BoletaxEmpleadorxAlfa()
        {
            InitializeComponent();
        }
        ...
        private void ui_mostrarBoletas()
        {
            ...
            string de_letra = cmbIni.Text.Trim();
            string a_letra = cmbFin.Text.Trim();
            ...
            query = query + " where P.rucemp='" + @rucemp + "' " + condicion;
            query = query + " and P.anio='" + @anio + "' and P.messem='" + @messem + "' and ";
            query = query + " P.idcia='" + @idcia + "' and P.idtipoper='" + @idtipoper + "' ";
            query = query + " and P.idtipoplan='" + @idtipoplan + "' and P.idtipocal='" + @idtipocal + "' ";
            query = query + " and SUBSTRING(A.apepat,1,1)  between '" + @de_letra + "' and  '" + @a_letra + "' ";
        ...
        private void cmbIni_SelectedIndexChanged(object sender, EventArgs e)
        {
            ui_mostrarBoletas();
        }
        ...
        private void ui_BoletaxEmpleadorxAlfa_Load(object sender, EventArgs e)
        {
            Funciones funciones = new Funciones();
            GlobalVariables variables = new GlobalVariables();
            string squery;
