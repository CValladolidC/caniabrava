...
{
    public partial class ui_updtrabajadores : Form
    {
        //Oliver Cruz Tuanama
        ...
        public void ui_loadPerPlan(string idcia, string idperplan)
        {
            ...
            try
            {
                ...
                if (myReader.Read())
                {
                    ...
                    query = "SELECT clavemaesgen as clave,desmaesgen as descripcion FROM maesgen WHERE idmaesgen='040' and parm1maesgen='" + myReader["idcia"] + "';";
                    ...
                    maesgen.consultaDetMaesGen("050", myReader["rpm"].ToString(), cmbPosicion);
        ...
        public void ui_ActualizaComboBox()
        {
            ...
            maesgen.listaDetMaesGen("050", cmbPosicion, "B");
            ...
            maesgen.listaDetMaesGen("040", cmbGerencia, "B");
            ...
            //string clave = funciones.getValorComboBox(cmbCategoriaOcupacional, 2);
            //query = "Select idlabper as clave,deslabper as descripcion from labper where idtipoper='" + @clave + "' and idcia='" + @idcia + "';";
            //funciones.consultaComboBox(query, cmbOcupacion);
            ...
            //query = "SELECT CAST(idplantiphorario AS CHAR) as clave, descripcion FROM plantiphorario WHERE idcia='" + @idcia + "' and estado = 0 ;";
            //funciones.listaComboBox(query, cmbGerencia, "B");
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (txtValid.Text.Equals("G"))
            {
                ...
                string idlabper = funciones.getValorComboBox(cmbOcupacion, 8);
                ...
                string domicilia;
                string esvida;
                string regalterna = string.Empty;
                string trabmax = string.Empty;
                string trabnoc = string.Empty;
                string quicat;
                string renexo;
                string asepen;
                string exoquicat;
                ...
                string idTipHorario = funciones.getValorComboBox(cmbGerencia, 4);
        ...
        public void ui_listaDerechohabientes(string idcia, string idperplan)
        {
            ...
            conexion.Open();
            string query;
            query = "Select rtrim(A.apepat)+' '+rtrim(A.apemat)+', '+rtrim(A.nombres) as nombre,A.fecnac,";
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (txtOperacion.Text.Trim().Equals("EDITAR"))
            {
                ...
                DateTime fecini = DateTime.Parse(fechaini);
                DateTime? fecfin = null;
                if (fechafin != "  /  /") { fecfin = DateTime.Parse(fechafin); }

                if (valorValida.Equals("G"))
                {
                    perlab.actualizarPerLab(operacion, idperlab, idcia, idperplan, fecini.ToString("yyyy-MM-dd"), fecfin.Value.ToString("yyyy-MM-dd"), motivo);
