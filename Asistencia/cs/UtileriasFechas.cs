...
namespace CaniaBrava
{
    class UtileriasFechas
    {
        ...
        public string dayOfWeek(string fecha)
        {
            ...
            int diaini = int.Parse(fecha.Substring(0, 2));
            int mesini = int.Parse(fecha.Substring(3, 2));
            int anioini = int.Parse(fecha.Substring(6, 4));
            DateTime date = new DateTime(anioini, mesini, diaini);
            return date.ToString("ddd", new CultureInfo("es-ES"));
